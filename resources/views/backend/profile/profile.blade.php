        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ asset('public/storage/backend/profile_photo/' . $user->profile_photo_path) }}" alt="Profile" class="rounded-circle">
                    ...
                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                        ...
                        <div class="col-md-8 col-lg-9">
                          <img src="{{ asset('public/storage/backend/profile_photo/' . $user->profile_photo_path) }}" alt="Profile" width="100">
                          <div class="pt-2">
