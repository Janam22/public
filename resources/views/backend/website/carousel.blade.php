              ...
              @csrf
                ...
                <div class="col-md-6">
                  <label for="inputName5" class="form-label">Carousel Image 1</label>
                          <img src="{{ asset('public/storage/backend/carousel_images/' . $carouseldata->image_1) }}" alt="Carousel Image 1" width="100">
                          <div class="pt-2">
                ...
                <div class="col-md-6>
                  <label for="inputName5" class="form-label">Carousel Image 2</label>
                          <img src="{{ asset('public/storage/backend/carousel_images/' . $carouseldata->image_2) }}" alt="Carousel Image 2" width="100">
                          <div class="pt-2">
                ...
                <div class="col-md-6>
                  <label for="inputName5" class="form-label">Carousel Image 3</label>
                          <img src="{{ asset('public/storage/backend/carousel_images/' . $carouseldata->image_3) }}" alt="Carousel Image 3" width="100">
                          <div class="pt-2">
