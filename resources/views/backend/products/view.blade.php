            ...
            <div class="card-body pt-3">
              <div class="tab-content pt-2">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 label">MRP</div>
                    <div class="col-lg-6 col-md-6">{{ $product->mr_price }}</div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 label">Unit Info</div>
                    <div class="col-lg-6 col-md-6">{{ $product->unit_info }}</div>
                  </div>
