...
<header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <button type="submit" class="logo d-flex align-items-center" style="border:none; background:transparent;"><img src="{{ asset('public/backend/images/logo/logo.png') }}" alt=""></button>
            </form>
  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        <img src="{{ asset('public/storage/backend/profile_photo/' . Auth::user()->profile_photo_path) }}" alt="Profile" class="rounded-circle">
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li>
    <a class="nav-link {{ request()->routeIs('backend.cancelreasons.index') ? '' : 'collapsed' }}" style="border:none" href="{{ route('backend.cancelreasons.index') }}"><i class="fa fa-close"></i><span>Set Cancellation Reasons</span></a>
  </li>
