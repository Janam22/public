            ...
            <div class="container">
                <div class="row addres-add-parentrow">
                    <div class="col-lg-12 col-md-12">
                        <div class="dash__box dash__box--bg-white addAddressParent">
                            <div class="dash__pad-2">
                                ...
                                <form action="{{ route('frontend.address.create') }}" method="POST">
                                    ...
                                    <!-- Submit Button -->
                                     <div style="margin-top: 27px;" class="d-flex justify-evenly align-items-center">
...
<script>
    $(document).ready(function() {
        ...
        $('#city').on('change', function() {
            ...
            if (city_id) {
                $.ajax({
                    url: "/getZone/" + city_id, // URL should match the route
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
