...
class CustomerAddressBook extends Model
{
    ...
    protected $fillable = [
        'customer_id','full_name', 'phone', 'province_id', 'city_id', 'address', 'landmark', 'address_type', 'default_shipping', 'default_billing', 'zone_id'
    ];
    ...
    {
        return $this->belongsTo(AddressZone::class, 'zone_id', 'id'); // Adjust according to actual column names
    }
