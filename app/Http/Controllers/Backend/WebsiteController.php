...
class WebsiteController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $websitedata->header_theme_color = $request->input('header_theme_color');
        $websitedata->footer_theme_color = $request->input('footer_theme_color');
        $websitedata->text_theme_color = $request->input('text_theme_color');
        $websitedata->hover_effect_color = $request->input('hover_effect_color');
        ...
        $websitedata->shipping_cost_apply_type = $request->input('shipping_option');
        $websitedata->no_category_display = $request->input('no_category_display');
        $websitedata->map_url = $request->input('map_url');
